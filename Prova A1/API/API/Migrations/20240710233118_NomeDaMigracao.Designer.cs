...
namespace API.Migrations
{
    ...
    [Migration("20240710233118_NomeDaMigracao")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 7, 11, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5303),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 7, 12, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5314),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 13, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5319),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 7, 17, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5490),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 7, 13, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5495),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 24, 20, 31, 18, 482, DateTimeKind.Local).AddTicks(5499),
